...
namespace Nop.Web.Controllers
{
    public class CatalogController : BaseNopController
    {
        ...
        public ActionResult CategoryNavigation(int currentCategoryId, int currentProductId)
        {
            ...
            string cacheKey = string.Format(ModelCacheEventConsumer.CATEGORY_CHILD_IDENTIFIERS_MODEL_KEY, currentCategoryId, currentProductId, _workContext.WorkingLanguage.Id);
            var cacheModel = _cacheManager.Get(cacheKey, () =>
            {
